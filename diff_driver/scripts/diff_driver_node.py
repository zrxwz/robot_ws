...
#   y: 0.0
#   z: 0.5"
# rostopic pub /cmd_vel geometry_msgs/Twist --once "linear: {x: 0.2, y: 0.0, z: 0.0} angular: {x: 0.0, y: 0.0, z: 0.0}"
# rostopic pub /cmd_vel geometry_msgs/Twist --once "linear: {x: -0.2, y: 0.0, z: 0.0} angular: {x: 0.0, y: 0.0, z: 0.0}"
# rostopic pub /cmd_vel geometry_msgs/Twist --once "linear: {x: 0.0, y: 0.0, z: 0.0} angular: {x: 0.0, y: 0.0, z: -0.5}"
# rostopic pub /cmd_vel geometry_msgs/Twist --once "linear: {x: 0.0, y: 0.0, z: 0.0} angular: {x: 0.0, y: 0.0, z: 0.5}"
