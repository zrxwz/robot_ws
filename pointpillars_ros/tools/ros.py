#!/home/zhurui/miniconda3/envs/pp/bin/python
...
import sys
sys.path.append("/home/zhurui/robot_ws/src/pointpillars_ros")
...
class Pointpillars_ROS:
    ...
    def init_ros(self):
        ...
        config_path = rospy.get_param("/config_path", "/home/zhurui/robot_ws/src/pointpillars_ros/tools/cfgs/kitti_models/pointpillar.yaml")
        ckpt_path = rospy.get_param("/ckpt_path", "/home/zhurui/robot_ws/src/pointpillars_ros/checkpoint_epoch_150.pth")
        # # subscriber
...
if __name__ == '__main__':
    ...
    sub_velo = rospy.Subscriber("/rslidar_points", PointCloud2, sec.lidar_callback, queue_size=1,
                                    buff_size=2 ** 12)
